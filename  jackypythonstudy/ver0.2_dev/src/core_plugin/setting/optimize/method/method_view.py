...
from method_xrc import xrcMethod
class MethodView(xrcMethod, ViewBase):

    implements(IMethodView)

    def __init__(self, parent):
        """Constructor."""
        xrcMethod.__init__(self, parent)
