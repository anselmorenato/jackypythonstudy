...
class ManagerPresenter(object):
    ...
    def append(self, job):
        ...
        irow = self.append_row( job.id )
        self.append_col( irow , 1 , job.name          ) 
        self.append_col( irow , 2 , state , image     ) 
        self.append_col( irow , 3 , job.location      ) 
        self.append_col( irow , 4 , job.start_time    ) 
        self.append_col( irow , 5 , job.expected_time ) 
        self.append_col( irow , 6 , job.elasped_time  ) 
        self.append_col( irow , 7 , job.finish_time   ) 
        self.append_col( irow , 8 , job.project       ) 
        self.append_col( irow , 9 , job.jms           ) 
