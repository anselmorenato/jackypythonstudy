...
class ILocationModel():
    ...
    @abstractmethod
    def get_environ_dict(self): pass
    @abstractmethod
    def set_environ_dict(self, environ_dict): pass
    environ_dict = abstractproperty(get_environ_dict, set_environ_dict)
    ...
    # methods
    @abstractmethod
    def append_command(self): pass

    @abstractmethod
    def append_env_for_command(self): pass

    @abstractmethod
    def append_env_for_jms(self): pass

    @abstractmethod
    def append_jms(self): pass

    @abstractmethod
    def close(self): pass

    @abstractmethod
    def delete_command(self): pass

    @abstractmethod
    def delete_env_for_command(self): pass

    @abstractmethod
    def delete_env_for_jms(self): pass

    @abstractmethod
    def delete_jms(self): pass

    @abstractmethod
    def edit_env_for_command(self): pass

    @abstractmethod
    def edit_env_for_jms(self): pass
