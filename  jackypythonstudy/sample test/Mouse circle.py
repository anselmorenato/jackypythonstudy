...
class OGLCanvas(ogl.ShapeCanvas):
        def __init__(self, parent, frame):
                ...
                self.circle = ogl.CircleShape(50)
                ...
                self.constraining_shape = ogl.RectangleShape(120, 100)
                self.constrained_shape1 = ogl.CircleShape(50)
                self.constrained_shape2 = ogl.RectangleShape(80, 20)

                self.constraining_shape.SetBrush(wx.BLUE_BRUSH)
                self.constrained_shape2.SetBrush(wx.RED_BRUSH)
                self.diagram.AddShape(self.constrained_shape2)
                self.constrained_shape2.Show(True)
